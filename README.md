...
|---|---|---|
| [`uk-employment-legal`](./uk-employment-legal) | England & Wales employment law | 3 |
...
- Scotland (Court of Session / Sheriff Court; separate ET; different settlement-agreement conditions).
...
- **Statutory citation per assertion.** Every legal claim points at the statute, rule, or authority it relies on — to be verified, never trusted blind.
- **Time-limit discipline.** Drafting skills surface the limitation date before generating, and tell the user to confirm it with a calculator. Missed limitation is the most common malpractice in employment law.
- **CPR 31.22 implied-undertaking screen.** Document-handling skills confirm permitted use before extracting from disclosed material. (The hard gate is enforced by the host workspace, not the prompt.)
...
- Verify case law or legislation against a live source — these are prompt-only skills; any citation must be checked against the official register before it reaches a brief. AI-hallucinated cites have already led to UK tribunal sanction ([Harber v HMRC](https://www.bailii.org/uk/cases/UKFTT/TC/2023/TC09010.html)).
- Cover Scotland or Northern Ireland.
- Maintain currency without contribution — UK law moves (Employment Rights Bill 2025, CPR updates three times a year, statutory caps annually).
